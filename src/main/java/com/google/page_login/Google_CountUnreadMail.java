...
public class Google_CountUnreadMail extends LoginPage_Google {
	...
	public int countUreadMails()
	{
		...
		List<WebElement> list = driver.findElements(By.xpath(Configuration.unreadmail));
